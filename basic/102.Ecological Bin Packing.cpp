    ...
    while(cin>>a[0][0])
    {
        ...
        for(i=1;i<3;i++)
            for(j=0;j<3;j++)
                cin>>a[i][j];
        //BCG
        sum=a[1][0]+a[2][0]+a[0][1]+a[1][1]+a[0][2]+a[2][2];
        cs=1;
        //BGC
        tmp=a[1][0]+a[2][0]+a[0][1]+a[2][1]+a[0][2]+a[1][2];
        if(tmp<sum)
        {
            sum=tmp;
            cs=2;
        ...
        //CBG
        tmp=a[0][0]+a[2][0]+a[0][1]+a[1][1]+a[1][2]+a[2][2];
        if(tmp<sum)
        {
            sum=tmp;
            cs=3;
        ...
        //CGB
        tmp=a[0][0]+a[1][0]+a[0][1]+a[2][1]+a[1][2]+a[2][2];
        if(tmp<sum)
        {
            sum=tmp;
            cs=4;
        ...
        //GBC
        tmp=a[0][0]+a[2][0]+a[1][1]+a[2][1]+a[0][2]+a[1][2];
        if(tmp<sum)
        {
            sum=tmp;
            cs=5;
        ...
        //GCB
        tmp=a[0][0]+a[1][0]+a[1][1]+a[2][1]+a[0][2]+a[2][2];
        if(tmp<sum)
        {
            sum=tmp;
            cs=6;
